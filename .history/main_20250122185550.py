...
DATABASE_CONFIG = {
    "host": os.getenv("DB_HOST", "databasefastapi.c1660ow0ylh2.us-east-1.rds.amazonaws.com"),
    "user": os.getenv("DB_USER", "admin"),
    "password": os.getenv("DB_PASSWORD", "CDAR159930j"),
    "database": os.getenv("DB_NAME", "databasefastapi")
}
